        ...
        if ($action == "enroll") {
            if (mysqli_num_rows($check) == 0) {
                mysqli_query($conn, "INSERT INTO student_registrations
                    ...
                    VALUES
                    ('$student_id', '$current_year', '$current_semester', '$year_level', '$course', '$mol', 'ENROLLED', NOW())");
            ...
            if (mysqli_num_rows($check) == 0) {
                mysqli_query($conn, "INSERT INTO student_registrations
                    (student_id, academic_year, semester, year_level, course, mol, status, date_registered)
                    VALUES
                    ('$student_id', '$current_year', '$current_semester', '$year_level', '$course', '$mol', 'CANCELLED', NOW())");
